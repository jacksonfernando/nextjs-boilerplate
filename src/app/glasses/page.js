...
import { SUNGLASSES_TYPE, HOME_GLASSES_DESCRIPTION, HOME_GLASSES_TITLE, PRODUCT_OFFSET, PRODUCT_LIMIT } from "@/constants/global";
...
const Page = () => {
  ...
  const renderHeroSection = () => {
    const HERO_SECTION_TITLE = 'Sunglasses'
    const HERO_SECTION_DESCRIPTION = 'Stay on trend with our latest styles of sunglasses collection.'
